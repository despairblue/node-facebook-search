...
FacebookSearch.prototype.requestAccessToken = function(opts, cb) {
    ...
    if(self.auth.code) {
        ...
        oauth.getOAuthAccessToken(null, {'client_id': self.auth.key, 'client_secret': self.auth.secret, 'redirect_uri': opts.redirect_uri, 'code': self.auth.code}, _handleTokenResponse);
    } else {
